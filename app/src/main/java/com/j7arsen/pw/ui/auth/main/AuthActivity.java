...
public class AuthActivity extends BaseContainerActvitiy implements IAuthView {
    ...
    private Navigator navigator = new SupportFragmentNavigator(getSupportFragmentManager(), R.id.fl_container) {
        ...
        protected void exit() {
            finish();
            UI.animationCloseActivity(AuthActivity.this);
        }

        @Override
        protected void setupFragmentTransactionAnimation(Command command, Fragment currentFragment, Fragment nextFragment, FragmentTransaction fragmentTransaction) {
            if(!(nextFragment instanceof SignInFragment)) {
